...
const buildContraChequeHtml = (detail) => {
    ...
    return `
        ...
        <html>
            ...
            <body>
                ...
                <div class="summary-row"><span>Adiantamentos</span><span>${escapeHtml(formatCurrency(detail?.advances_total))}</span></div>
                <div class="summary-row"><span>Vales</span><span>${escapeHtml(formatCurrency(detail?.vales_total))}</span></div>
                <div class="summary-row"><span>Saldo</span><span>${escapeHtml(formatCurrency(detail?.balance))}</span></div>
                <div class="divider"></div>
...
export default function FolhaPagamento({
    ...
    const handlePrintContraCheque = (detail) => {
        ...
        if (!printWindow) {
            setPrintError('Permita pop-ups para imprimir o contra-cheque.');
            return;
        }

        printWindow.document.write(buildContraChequeHtml(detail));
