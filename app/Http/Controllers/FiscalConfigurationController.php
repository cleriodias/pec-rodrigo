...
class FiscalConfigurationController extends Controller
{
    ...
    ): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'tb26_exigir_tef_integrado' => ['nullable', 'boolean'],
        ...
        try {
            ...
            $configuration->fill([
                ...
                'tb26_exigir_tef_integrado' => (bool) ($data['tb26_exigir_tef_integrado'] ?? false),
            ...
            if ($requestedFiscalGenerationStatus !== $currentFiscalGenerationStatus) {
    ...
    private function defaultFiscalConfigurationPayload(int $selectedUnitId): array
    {
        return [
            ...
            'tb26_exigir_tef_integrado' => false,
    ...
    private function buildFiscalConfigurationPayload(
        ...
        return [
            ...
            'tb26_geracao_automatica_ativa' => (bool) ($configuration?->tb26_geracao_automatica_ativa ?? false),
            'tb26_exigir_tef_integrado' => (bool) ($configuration?->tb26_exigir_tef_integrado ?? false),
